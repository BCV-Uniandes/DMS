pipeline {
    agent {
        docker {
            ...
            args '--runtime=nvidia -u root -v /media/SSD2/referit_data:/root/referit_data -v /media/SSD2/test_data:/root/data -v /home/eamargffoy/.torch:/root/data/.torch -e PYTHONIOENCODING=UTF-8'
        }
    }
