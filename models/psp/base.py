...
"""
ResNet, SqueezeNet and DenseNet PyTorch modules.

Based on:
https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py

Taken from:
https://github.com/Lextal/pspnet-pytorch/blob/master/extractors.py
"""
...
"""
Implementation of dilated ResNet-101 with deep supervision.
Downsampling is changed to 8x
"""
model_urls = {
...
"""
Implementation of DenseNet with deep supervision.
Downsampling is changed to 8x
"""
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features,
        ...
        if downsample:
            ...
            self.add_module(
                'pool', nn.AvgPool2d(
                    kernel_size=1, stride=1))  # compatibility hack
