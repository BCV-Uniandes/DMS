...
"""
Pyramid Scene Parsing (PSP) Network PyTorch implementation.

Hengshuang Zhao, Jianping Shi, Xiaojuan Qi, Xiaogang Wang, Jiaya Jia:
Pyramid Scene Parsing Network. CoRR abs/1612.01105 (2016)
...
from . import base as extractors
...
class PSPModule(nn.Module):
    ...
    def forward(self, feats):
        ...
        priors = [F.upsample(
            input=stage(feats), size=(h, w), mode='bilinear')
...
class PSPNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return sources, self.final(p)  # , self.classifier(auxiliary)
